  ...
  return (
    <div className="flex flex-col gap-4 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 rounded-2xl  p-4">
        ...
        {domains.map((item) => (
          <div className="flex gap-2 p-3 rounded-lg items-center dark:bg-gradient-to-r dbtn shadow-xl border hover:border-slate-700 hover:animate-bounce    bg-slate-100" key={item.title}>
